...
const LINKS = [
    {
        label: "Live Demo",
        href: "https://ascend-app-pi.vercel.app/",
        icon: (
    ...
    {
        label: "GitHub",
        href: "https://github.com/kparhar07-star/Ascend-App",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="max-w-350 w-full flex flex-col lg:flex-row items-start lg:items-center justify-center gap-10 lg:gap-20">
                <div className="flex flex-col gap-6 max-w-3xl">
                    ...
                    <p data-reveal className="text-lg md:text-xl font-body leading-relaxed max-w-2xl">
                        A gamified task manager that turns daily routines into quests.
                        Built to fight doom-scrolling, overthinking, and lost productivity —
                        using the dopamine hit from completing tasks to keep users hooked on progress.
                    </p>
